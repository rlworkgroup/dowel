...
latex_documents = [
    (master_doc, 'dowel.tex', 'dowel Documentation',
...
man_pages = [(master_doc, 'dowel', 'dowel Documentation', [author], 1)]
...
texinfo_documents = [
    (master_doc, 'dowel', 'dowel Documentation', author, 'dowel',
